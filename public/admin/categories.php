...
<details>
    ...
    <form action="/estoque-sorveteria/category/store" method="POST" style="margin-top: 1rem;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($cat['ativo']): ?>
                            ...
                            <form action="/estoque-sorveteria/category/destroy/<?= $cat['id'] ?>" method="POST" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja desativar esta categoria?');">
                                <button type="submit">Desativar</button>
                            </form>
                        <?php else: ?>
                            <!-- Formulário de Reativação para categorias inativas -->
                            <form action="/estoque-sorveteria/category/reactivate/<?= $cat['id'] ?>" method="POST" style="display:inline;">
