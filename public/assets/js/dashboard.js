...
$(document).ready(function() {
    // Carregar resumo
    $.ajax({
        url: '/estoque-sorveteria/public/api/dashboard/summary',
        method: 'GET',
        dataType: 'json',
    ...
    $.ajax({
        url: '/estoque-sorveteria/public/api/dashboard/low-stock',
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            let html = '';
    ...
    $.ajax({
        url: '/estoque-sorveteria/public/api/dashboard/recent-movements',
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            let html = '';
    ...
    $.ajax({
        url: '/estoque-sorveteria/public/api/dashboard/stock-turnover',
        method: 'GET',
        dataType: 'json',
        success: function(data) {
