...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {  
        ...
        if ($action === 'update') {  
            ...
            if ($movimentacaoId) {  
                ...
                if ($movimentacaoItem->adicionarItens($movimentacaoId, $cart, $valoresUnitarios)) {  
                    ...
                    header('Location: /estoque-sorveteria/public/produtos.php');  
                    exit;  
                }  
            }  
    ...
    header('Location: /estoque-sorveteria/public/cart.php');  
    exit;  
}  
...
<main class="container mt-4">  
    ...
    <a href="/estoque-sorveteria/public/produtos.php" class="btn">Voltar para Produtos</a>  
...
<script src="/estoque-sorveteria/public/assets/js/cart.js"></script>  
